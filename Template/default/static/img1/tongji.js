...
{
	var unit_id     = "2530989";
	var client_ip   = "122.72.35.169";
	var server_time = "1381840998";
	var verify_code = "14a0e59b";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2530989/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
