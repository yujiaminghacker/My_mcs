    ...
    <body>
        ...
        <div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav btn-group">
                <li class="btn btn-inverse"><a href="{|U:'Login/out'}" target="_self"><i class="icon icon-share-alt"></i> <span class="text">Exit</span></a></li>
            </ul>
        </div>
         <!-- 左边 分类管理 -->
        <div id="sidebar">
        ...
        <div id="content">
            ...
            <table class="table2">
                ...
                <list from="$dirs" name="d">
                    <tr>
                        <td>{$hd.list.d.index}</td>
                        <td>{$d.name|date:'Y-m-d H:i:s',@@}</td>
                        <td>
                            <a href="{|U:recovery,array('dirname'=>$d['name'])}">还原</a> |
                            <a href="{|U:del,array('dirname'=>$d['name'])}">删除</a>
                        </td>
                    </tr>
                </list>
            </table>
