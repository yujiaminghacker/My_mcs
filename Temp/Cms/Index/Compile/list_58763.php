...
<link rel="stylesheet" type="text/css" href="http://localhost/My_mcs/template/default//static/css/qiye2.css"/>
<body>
	<div id="zuiwai"> 
		<div id="top-shang">
 	...
 	<div id="left"> 
 			...
 			<li class="left-2"><a href="http://localhost/My_mcs">网站首页</a></li>
 			<?php
		$where='';
		if(13){
			$where="pid=13";
