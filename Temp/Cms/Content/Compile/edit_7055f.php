...
<script type='text/javascript'>
		...
		URL = 'http://localhost/My_Cms/index.php/Content/Index/edit/id/1';
		...
		METH = 'http://localhost/My_Cms/index.php/Content/Index/edit';
...
<div class="warp">
    ...
    <form action="http://localhost/My_Cms/index.php/Content/Index/edit" method="post" class="hd-form" enctype="multipart/form-data">
                ...
                <div id="base">
                    <table class="table1">
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                   <input type="checkbox" name='flag[]' value="置顶" <?php if(strstr($field['flag'],'置顶')){?>checked='checked'<?php }?>/> 置顶
                                </label>
                                <label>
                                    <input type="checkbox" name='flag[]' value="推荐" <?php if(strstr($field['flag'],'推荐')){?>checked='checked'<?php }?>/> 推荐
                                </label>
                            </td>
                        </tr>
                        <tr>
...
if($_index_c>=$_total_c):$hd["list"]["c"]["last"]=true;endif;?>
                                        ...
                                        <!-- 默认选中-->
                                         <option value="<?php echo $c['cid'];?>" <?php if($c['cid']==$field['category_cid']){?>selected='selected'<?php }?>><?php echo $c['_name'];?></option>
...
echo "";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="old_thumb" value="<?php echo $field['thumb'];?>"/>
                                <img src="http://localhost/My_Cms/<?php echo $field['thumb'];?>" width="88" height="88"/>
                            </td>
                        </tr>
                        <tr>
                            <td>正文</td>
                ...
                <div id="ext">
                    <table class="table1">
                        ...
                        <tr>
                            <td>点击数</td>
                            <td>
                                <input type="text" class='w300' name="click" value="<?php echo $field['click'];?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>发表时间</td>
                            <td>
                                <input type="text" readonly="readonly" id="addtime" name="addtime"
                                       value="<?php echo date('Y-m-d H:i',$field['addtime']);?>"
                                       class="w150"/>
                                <script>
